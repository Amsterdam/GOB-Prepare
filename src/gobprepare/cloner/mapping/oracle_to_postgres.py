...
def _oracle_number_to_postgres(
    length: Optional[int] = None, precision: Optional[int] = None, scale: Optional[int] = None
) -> str:
    """Return the Postgres equivalent of the Oracle NUMBER column type for given length, precision and scale.
...
_oracle_postgresql_column_mapping: dict[str, Callable[[Optional[int], Optional[int], Optional[int]], str]] = {
...
def get_postgres_column_definition(
    data_type: str, length: Optional[int] = None, precision: Optional[int] = None, scale: Optional[int] = None
) -> str:
    """Return the (string representation of the) Postgres equivalent of an Oracle column definition.
