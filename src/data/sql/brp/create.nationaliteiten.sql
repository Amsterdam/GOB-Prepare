SELECT
  ...
  brp_datum_prefix_nat."Datumdocument"                                             AS datum_document,
  nat."DocumentOms"::varchar                                                       AS beschrijving_document,

  nat."GegevensInOnderzoek"::varchar                                               AS aanduiding_gegevens_in_onderzoek,
  brp_datum_prefix_nat."DatumIngangOnderzoek"                                      AS datum_ingang_onderzoek,
  brp_datum_prefix_nat."DatumEindeOnderzoek"                                       AS datum_einde_onderzoek,
  NULL::varchar                                                                    AS onjuist_strijdig_openbare_orde,

  brp_datum_prefix_nat."DatumGeldigheid"                                           AS ingangsdatum_geldigheid,
  brp_datum_prefix_nat."DatumOpname"                                               AS datum_opneming,
