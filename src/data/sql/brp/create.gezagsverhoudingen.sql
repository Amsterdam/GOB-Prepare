CREATE TABLE brp_prep.gezagsverhoudingen AS
  ...
  SELECT
    ...
    CASE -- datum ontlening gezagsverhouding
      ...
      WHEN gv."DatumOntlening" = '0' THEN '0000-00-00'
      WHEN length(gv."DatumOntlening") = 8 THEN CONCAT_WS(
          '-',
    ...
    CASE -- ingang datum gelidgheid
      ...
      WHEN gv."DatumGeldigheid" = '0' THEN '0000-00-00'
      WHEN length(gv."DatumGeldigheid") = 8 THEN CONCAT_WS(
          '-',
    ...
    CASE -- datum opneming
      ...
      WHEN gv."DatumOpname" = '0' THEN '0000-00-00'
      WHEN length(gv."DatumOpname") = 8 THEN CONCAT_WS(
          '-',
