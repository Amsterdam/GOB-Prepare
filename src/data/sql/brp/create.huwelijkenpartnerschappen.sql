SELECT
  ...
  brp_datum_prefix_hwp."Geboortedatum"                                               AS partner_geboortedatum,

  hwp."GeslachtsaanduidingOms"                                                       AS partner_geslachtsaanduiding,

  brp_datum_prefix_hwp."DatumSluitingHuwelijkPartnerschap"                           AS partner_datum_sluiting_huwelijk_partnerschap,
  ...
  brp_datum_prefix_hwp."DatumOntbindingHuwelijkPartnerschap"                         AS partner_datum_ontbinding_huwelijk_partnerschap,
  ...
  brp_datum_prefix_hwp."DatumIngangOnderzoek"                                      AS datum_ingang_onderzoek,
  brp_datum_prefix_hwp."DatumEindeOnderzoek"                                       AS datum_einde_onderzoek,
  NULL::varchar                                                                    AS onjuist_strijdig_openbare_orde,

  brp_datum_prefix_hwp."DatumGeldigheid"                                           AS ingangsdatum_geldigheid,

  brp_datum_prefix_hwp."DatumOpname"                                               AS datum_opneming,
