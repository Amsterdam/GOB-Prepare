CREATE TABLE brp_prep.overlijdens AS
  ...
  SELECT
    ...
    ov."AkteGemeenteOms"::varchar                                                    AS plaats_overlijden,
    ov."AkteLandOms"::varchar                                                        AS land_overlijden,

    JSONB_BUILD_OBJECT( -- registergemeente akte
      'code',ov."AkteGemeenteOms"::varchar
    )                                                                                AS registergemeente_akte,
    JSONB_BUILD_OBJECT( -- vakte nummer
      'code', ov."AkteNr"::varchar,
      'omschrijving', ov."AkteGemeenteOms"::varchar
    )                                                                                AS aktenummer,
