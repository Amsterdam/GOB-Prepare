...
FROM brk.zakelijkrecht zrt
         LEFT JOIN brk_prep.kadastraal_object kot
                   ON zrt.rust_op_kadastraalobject_id = kot.nrn_kot_id AND zrt.rust_op_kadastraalobj_volgnr = kot.nrn_kot_volgnr;
    ...
    LOOP
        ...
        FROM (SELECT zrtbelastmet.id,
              ...
              WHERE zrtkot.rust_op_kadastraalobject_id IS NOT NULL
                AND zrtbelastmet.rust_op_kadastraalobject_id IS NULL) AS v(id, kot_id, kot_volgnr, kot_identificatie,
