...
, CASE
 -- WHEN bon.overlijdensdatum IS NOT NULL THEN bon.overlijdensdatum 													--tijdelijk uit voor analyse           
    WHEN sjt.datum_overlijden  IS NOT NULL THEN sjt.datum_overlijden
...
, obu.land_code														AS woonadres_buitenland_code
, lbu.omschrijving					                                AS woonadres_buitenland_naam
    --**postadres**
...
, pau.land_code														AS postadres_buitenland_code
, lbu.omschrijving					                                AS postadres_buitenland_naam
