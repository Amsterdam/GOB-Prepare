...
SELECT tng.identificatie                          AS identificatie,
       ...
       LEAST(zrt._expiration_date, atg.einddatum) AS eind_geldigheid,
       LEAST(zrt._expiration_date, atg.einddatum) AS datum_actueel_tot,
       LEAST(zrt._expiration_date, atg.einddatum) AS _expiration_date,
