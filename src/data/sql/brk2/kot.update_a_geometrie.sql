...
WHERE kot1.indexletter = 'A'
  ...
  AND kot1.aangeduid_door_kadastralegemeentecode_brk_code = kot2.aangeduid_door_brk_kadastralegemeentecode_code
...
WITH near_a_poly AS (
    ...
    FROM brk2_prep.kadastraal_object kot1
             JOIN brk2_prep.kadastraal_object kot2
                  ON kot1.__kadastrale_aanduiding_minus_index_nummer = kot2.__kadastrale_aanduiding_minus_index_nummer
                      AND kot2._expiration_date IS NULL
