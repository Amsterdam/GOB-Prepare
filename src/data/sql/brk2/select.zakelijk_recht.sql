...
SELECT zrt_kot.volgnummer                                       AS volgnummer,
       ...
       zrt_kot.begin_geldigheid::timestamp                      AS begin_geldigheid,
       zrt_kot.eind_geldigheid::timestamp                       AS eind_geldigheid,
       zrt_kot.toestandsdatum::timestamp                        AS toestandsdatum,
       zrt_kot.datum_actueel_tot::timestamp                     AS datum_actueel_tot,
       zrt_kot._expiration_date::timestamp                      AS _expiration_date,
