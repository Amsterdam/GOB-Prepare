...
SELECT sjt.Identificatie_subject            AS identificatie,
       ...
       sjt.Code_Beschikkingsbevoegdheid     AS beschikkingsbevoegdheid,
       ...
       sjt.Voorvoegsels                     AS voorvoegsesls,
       ...
       sjt.Datum_overlijden                 AS datum_overlijden,
       ...
       sjt.Woonlocatie_type                 AS woonadres_type,
       ...
       sjt.Postlocatie_type                 AS postadres_type,
       ...
       pbl.postbusnummer                    AS postadres_postbus_nummer,
