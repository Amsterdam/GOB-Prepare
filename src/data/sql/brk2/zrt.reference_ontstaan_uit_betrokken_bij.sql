-- Reference betrokken_bij_zakelijkerechten and determine __max_betrokken_bij_begindatum
UPDATE brk2_prep.zakelijk_recht zrt
SET betrokken_bij_zakelijkerechten=q2.betrokken_bij_zakelijkerechten,
    __max_betrokken_bij_begindatum=q2.__max_betrokken_bij_begindatum
FROM (
    SELECT
             json_agg(json_build_object('zrt_identificatie', identificatie) ORDER BY identificatie) betrokken_bij_zakelijkerechten,
...
-- Reference ontstaan_uit_zakelijkerechten and determine __max_ontstaan_uit_begindatum
UPDATE brk2_prep.zakelijk_recht zrt
SET ontstaan_uit_zakelijkerechten=q2.ontstaan_uit_zakelijkerechten,
    __max_ontstaan_uit_begindatum=q2.__max_ontstaan_uit_begindatum
FROM (
    SELECT
             json_agg(json_build_object('zrt_identificatie', identificatie) ORDER BY identificatie) ontstaan_uit_zakelijkerechten,
